          ...
          <form onSubmit={handleSearch} className="flex flex-col md:flex-row gap-4">
            <div className="flex-1 relative">
              ...
              <input
                ...
                className="w-full rounded-xl pl-12 pr-4 py-3 focus:outline-none focus:border-secondary/50 transition-all bg-input-bg border border-input-border text-black placeholder:text-gray-500"
              />
            </div>
            <button
              type="submit"
