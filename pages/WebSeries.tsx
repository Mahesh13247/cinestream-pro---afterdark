...
const WebSeries = () => {
    ...
    const fetchTV = useCallback(async (pageNum: number) => {
        try {
            if (pageNum === 1) setLoading(true);
            else setIsFetchingMore(true);

            const results = await tmdbApi.getDiscoverTV(pageNum);
    ...
    }, [isFetchingMore, hasMore, page, fetchTV]);
        ...
        <div className="min-h-screen bg-background pt-24 pb-20 px-4">
            <div className="w-full max-w-[2000px] mx-auto px-4 md:px-8">
                <div className="flex items-center gap-3 mb-8">
                    ...
                    <h1 className="text-3xl font-bold text-text">Web Series & TV Shows</h1>
                </div>
